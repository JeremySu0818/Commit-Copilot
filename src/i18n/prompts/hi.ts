...
export const hiPrompt: LocalePromptBundle = {
  ...
  diffCoverageRequirement:
    'पूर्ण diff कवरेज चालू है। `write_commit_message` को कॉल करने से पहले, हर बदली गई फ़ाइल के लिए `get_diff` को सफलतापूर्वक कॉल करें। आप एक `paths` ऐरे में कई फ़ाइलें शामिल कर सकते हैं।',
